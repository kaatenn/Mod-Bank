...
public class BlockRegister {
    ...
    public static final RegistryObject<Block> RAPID_RIPENING_DEVICE_BLOCK = BLOCKS.register("rapid_ripening_device", () -> new RapidRipeningDeviceBlock(BlockBehaviour.Properties.of().strength(1.0f).sound(SoundType.GLASS)));
}
